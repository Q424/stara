...
{
if (!QGlobal::SCNLOADED) _screen_x_font = Global::iWindowWidth;
if (!QGlobal::SCNLOADED) _screen_y_font = Global::iWindowHeight;

if (QGlobal::SCNLOADED) _screen_x_font = 1280;
if (QGlobal::SCNLOADED) _screen_y_font = 1024;
...
//farba bodu = (pôvodná farba * ALPHA)	+	(kreslená farba - pôvodná farba)
	...
	glBindTexture(GL_TEXTURE_2D, QGlobal::bfonttex);		// Select Our Font Texture
